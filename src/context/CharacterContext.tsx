...
const themes: Record<CharacterId, CharacterTheme> = {
  ...
  spidey: {
    ...
    catchphrase: 'Stay sharp. Stay focused. Be unstoppable. 🕸️',
    hoverPhrases: ['With great power comes great focus! 🕸️', "You're swinging through it!", 'Great job, hero! 🦸', "Spidey sense says: you're crushing it!", "Don't look down, keep climbing!"],
    chatOpener: "Hey hero! 🕷️ Spidey's got your back! Your stats are looking legendary today!",
  },
  batman: {
    id: 'batman',
    name: 'Batman',
  ...
  cat: {
    ...
    greeting: 'Purr-fect day, Kashvi!', personality: 'calm and curious',
  ...
  bunny: {
    ...
    footerBg: 'rgba(255,255,255,0.4)', mode: 'light',
    greeting: 'Hop to it, Kashvi!', personality: 'bubbly and energetic',
  ...
  dino: {
    ...
    footerBg: 'rgba(255,255,255,0.4)', mode: 'light',
    greeting: 'RAWR! Ready, Kashvi?', personality: 'prehistoric and powerful',
  ...
  puppy: {
    ...
    footerBg: 'rgba(255,255,255,0.4)', mode: 'light',
    greeting: 'Woof woof, Kashvi!', personality: 'loyal and enthusiastic',
  ...
  bear: {
    ...
    footerBg: 'rgba(255,255,255,0.4)', mode: 'light',
    greeting: 'Growl... Ready, Kashvi!', personality: 'calm and steady',
